...
public class Constants {
	public static final MappingResolver MAPPING_RESOLVER = FabricLoader.getInstance()
	                                                                   .getMappingResolver();
	public static final String ENTITY_CLASS_NAME = MAPPING_RESOLVER.mapClassName("intermediary", "net.minecraft.class_1297");
	public static final String DAMAGE_METHOD_NAME = MAPPING_RESOLVER.mapMethodName("intermediary",
	...
	public static final String DAMAGE_METHOD_DESC = "(L" + DAMAGE_SOURCE_CLASS_NAME.replace('.', '/') + ";F)Z";
